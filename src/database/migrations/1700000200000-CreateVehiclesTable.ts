    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'vehicle_type', type: 'enum', enum: ['SEDAN', 'SUV', 'TRUCK', 'VAN', 'BIKE', 'MOTORCYCLE'], default: "'SEDAN'" },
          ...
          { name: 'vehicle_status', type: 'enum', enum: ['ACTIVE', 'INACTIVE', 'MAINTENANCE', 'RETIRED'], default: "'ACTIVE'" },
          { name: 'document_verified', type: 'boolean', default: false },
          { name: 'inspection_status', type: 'enum', enum: ['PENDING', 'PASSED', 'FAILED'], default: "'PENDING'" },
          { name: 'created_at', type: 'timestamp', default: 'CURRENT_TIMESTAMP' },
          { name: 'updated_at', type: 'timestamp', default: 'CURRENT_TIMESTAMP', onUpdate: 'CURRENT_TIMESTAMP' },
          { name: 'deleted_at', type: 'timestamp', isNullable: true },
        ],
        foreignKeys: [
          { columnNames: ['driver_id'], referencedTableName: 'users', referencedColumnNames: ['id'], onDelete: 'CASCADE' },
        ],
        indices: [
