    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'order_type', type: 'enum', enum: ['DELIVERY', 'RIDE', 'SERVICE'], default: "'DELIVERY'" },
          { name: 'order_status', type: 'enum', enum: ['PENDING', 'ACCEPTED', 'IN_TRANSIT', 'COMPLETED', 'CANCELLED', 'FAILED'], default: "'PENDING'" },
          ...
          { name: 'estimated_distance', type: 'decimal', precision: 10, scale: 2, isNullable: true },
          ...
          { name: 'payment_method', type: 'enum', enum: ['CASH', 'CARD', 'WALLET', 'ONLINE'], default: "'CARD'" },
          { name: 'payment_status', type: 'enum', enum: ['PENDING', 'COMPLETED', 'FAILED'], default: "'PENDING'" },
        ...
        foreignKeys: [
          { columnNames: ['customer_id'], referencedTableName: 'users', referencedColumnNames: ['id'], onDelete: 'CASCADE' },
